...
export const getGroupsOverview = (class_id)             => http.get(`/api/classes/${class_id}/groups/overview`).then(r => r.data)
export const getGroup          = (group_id)             => http.get(`/api/groups/${group_id}`).then(r => r.data)
...
export const deleteMessage     = (group_id, message_id) => http.delete(`/api/groups/${group_id}/messages/${message_id}`).then(r => r.data)
export const getConclusion     = (group_id)             => http.get(`/api/groups/${group_id}/conclusion`).then(r => r.data)
export const setConclusion     = (group_id, data)       => http.put(`/api/groups/${group_id}/conclusion`, data).then(r => r.data)
